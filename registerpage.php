...
<body>
      ...
      ?>
            <form class="form1" name="myform" action="register.php" method="POST" enctype="multipart/form-data">
                  ...
                  <input class="un" type="file" class="form-control" placeholder="Upload Citizenship" name="file" id="file" required></input>
                  <input class="un" type="password" class="form-control" name="password" id="password" placeholder="Enter your new password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                  ...
                  <script type="text/javascript">
                        ...
                        password.onkeyup = function() {
                              ...
                              if (regexo.test(password.value)) {
                                    span[4].innerText = "Your password is valid";
                                    span[4].style.color = 'Green';

                              } else {
                                    span[4].innerText = "**Your password must have one uppercase letter,lowercase letter and Number ";
                        ...
                        number.onkeyup = function() {
                              ...
                              if (regexoo.test(number.value)) {
                                    span[3].innerText = "Your Mobile Number is valid";
                                    span[3].style.color = 'Green';

                              } else {
                                    span[3].innerText = "**Your Mobile Number is invalid ";
